...
The remaining variables are demographic ones whose meaning should be evident, except, perhaps, for `clasrank`. This uses US nomenclature for what year of 4 the student participant is in  (i.e., freshman = year 1, sophomore = year 2, junior = year 3, and senior = year 4) plus some additional values.
