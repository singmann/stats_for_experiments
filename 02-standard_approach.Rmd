...
[^standard_approach-1]: Urry et al. transformed the memory scores before their analysis based on an earlier paper doing the same. This was initially done to make it easy to compare the results for different types of memory scores [@muellerPenMightierKeyboard2014]. However, the memory scores from 0 to 100 are easier to understand than the transformed scores. As the results are qualitatively the same for both approaches, we use the untransformed memory scores here.
