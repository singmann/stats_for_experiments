...
Let us consider the the variables in Equation \@ref(eq:statmodel) in more detail. When doing so, we also consider how many different possible values each variable can take on.[^standard_approach-4] The following Figure, a variant of Figure \@ref(fig:laptop-dist), shows the elements graphically and we explain them in the text just below.
