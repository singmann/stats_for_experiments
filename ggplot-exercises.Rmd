...
As the last exercise, make a plot that shows the distribution and means of sleep efficiency and sleep time conditional on whether or not participants did have earworms during the night (i.e., at any time, excluding the control time point). Thus, in this analysis we ignore the experimental condition.

To perform the analysis, you need to begin with the same step as the corresponding analysis in the `tidyverse` exercises and then create one more sets of plots:
